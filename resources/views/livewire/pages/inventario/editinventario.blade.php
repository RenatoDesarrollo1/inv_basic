<x-modal name="editinventario" maxWidth="xl">
    <div class="p-4">
        <h2 class="text-md font-bold">Editar activo {{ $this->codigo }} - {{ $this->codigoubi }}</h2>
        <div class="mt-4">
            <form wire:submit.prevent="save">
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <x-input label="Nombre" type="text" wire:model="nombre" :error="$errors->first('nombre')" />
